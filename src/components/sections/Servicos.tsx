      ...
      <Container>
        ...
        <Stagger className="mt-14 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {services.map((service) => (
            ...
            >
              <div className="mb-6 inline-flex size-14 items-center justify-center rounded-2xl bg-brand-700 text-white shadow-lg shadow-brand-700/20 transition-colors group-hover:bg-brand-800">
